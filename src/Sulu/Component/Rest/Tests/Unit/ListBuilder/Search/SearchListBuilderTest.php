...
use Sulu\Component\Rest\ListBuilder\Search\PHPCRListBuilder;
...
class SearchListBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->listBuilder = new PHPCRListBuilder($this->indexName, $this->locale, $this->searchManager->reveal());
    }
